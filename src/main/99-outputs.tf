...
# ndp.platform.pagopa.it

output "ses_ndp_platform_pagopa_it_verification_token" {
  value = module.ses_ndp_platform_pagopa_it.verification_token
}

output "ses_ndp_platform_pagopa_it_dkim_tokens" {
  value = module.ses_ndp_platform_pagopa_it.dkim_tokens
}

output "ses_ndp_platform_pagopa_it_user_access_key_id" {
  value = module.ses_ndp_platform_pagopa_it.ses_user_access_key_id
}

output "ses_pagopa_ndp_platform_it_user_secret_access_key" {
  value     = module.ses_ndp_platform_pagopa_it.ses_user_secret_access_key
  sensitive = true
}